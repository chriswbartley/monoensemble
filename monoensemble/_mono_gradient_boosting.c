...
/* "_mono_gradient_boosting.pyx":24
 * 
 * ctypedef np.npy_float32 DTYPE_t          # Type of X
 * ctypedef np.npy_float64 DOUBLE_t         # Type of y, sample_weight             # <<<<<<<<<<<<<<
 * ctypedef np.npy_intp SIZE_t              # Type for indices and counters
...
/* "_mono_gradient_boosting.pyx":25
 * ctypedef np.npy_float32 DTYPE_t          # Type of X
 * ctypedef np.npy_float64 DOUBLE_t         # Type of y, sample_weight
 * ctypedef np.npy_intp SIZE_t              # Type for indices and counters             # <<<<<<<<<<<<<<
 * ctypedef np.npy_int32 INT32_t            # Signed 32 bit integer
...
static PyObject *__pyx_f_23_mono_gradient_boosting__log_logistic_sigmoid_(__pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_samples, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_X, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_out) {
  ...
  /* "_mono_gradient_boosting.pyx":50
 *                             float64 *X,
 *                             float64 * out):
 *     cdef int32 i=0             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":55
 *             out[i]=-log(1.+exp(-X[i]))
 *         else:
 *             out[i]=X[i]-log(1.+exp(X[i]))             # <<<<<<<<<<<<<<
 *     return
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":56
 *         else:
 *             out[i]=X[i]-log(1.+exp(X[i]))
 *     return             # <<<<<<<<<<<<<<
 * 
...
/* "_mono_gradient_boosting.pyx":59
 * 
 * 
...
static PyObject *__pyx_pw_23_mono_gradient_boosting_1_log_logistic_sigmoid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_log_logistic_sigmoid (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_log_logistic_sigmoid", 1, 2, 2, 1); __PYX_ERR(0, 59, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_log_logistic_sigmoid") < 0)) __PYX_ERR(0, 59, __pyx_L3_error)
      }
    ...
    __pyx_v_n_samples = __Pyx_PyInt_As_npy_int32(values[0]); if (unlikely((__pyx_v_n_samples == ((npy_int32)-1)) && PyErr_Occurred())) __PYX_ERR(0, 59, __pyx_L3_error)
    __pyx_v_X = ((PyArrayObject *)values[1]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_log_logistic_sigmoid", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 59, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_23_mono_gradient_boosting__log_logistic_sigmoid(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_samples, PyArrayObject *__pyx_v_X) {
  ...
  __pyx_pybuffernd_X.rcbuffer = &__pyx_pybuffer_X;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_23_mono_gradient_boosting_DOUBLE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 59, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0];

  /* "_mono_gradient_boosting.pyx":61
 * def _log_logistic_sigmoid(int32 n_samples,
 *                            np.ndarray[DOUBLE_t, ndim=1] X):
 *     out=np.empty_like(X)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __pyx_f_23_mono_gradient_boosting__log_logistic_sigmoid_(__pyx_v_n_samples, ((__pyx_t_23_mono_gradient_boosting_float64 *)((PyArrayObject *)__pyx_v_X)->data), ((__pyx_t_23_mono_gradient_boosting_float64 *)((PyArrayObject *)__pyx_v_out)->data)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "_mono_gradient_boosting.pyx":66
 *                             <float64*> (<np.ndarray> out).data
 *                             )
 *     return out             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_f_23_mono_gradient_boosting__custom_dot_(__pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_X, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_w, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_rows, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_cols, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_out) {
  ...
  /* "_mono_gradient_boosting.pyx":73
 *                   int32 n_cols,
 *                   float64 *out):
 *     cdef int32 i=0             # <<<<<<<<<<<<<<
 *     cdef int32 j=0
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":74
 *                   float64 *out):
 *     cdef int32 i=0
 *     cdef int32 j=0             # <<<<<<<<<<<<<<
 *     cdef float64 ttl=0.
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":75
 *     cdef int32 i=0
 *     cdef int32 j=0
 *     cdef float64 ttl=0.             # <<<<<<<<<<<<<<
 *     for i in range(n_rows):
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":76
 *     cdef int32 j=0
 *     cdef float64 ttl=0.
 *     for i in range(n_rows):             # <<<<<<<<<<<<<<
 *         ttl=0.
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "_mono_gradient_boosting.pyx":77
 *     cdef float64 ttl=0.
 *     for i in range(n_rows):
 *         ttl=0.             # <<<<<<<<<<<<<<
 *         for j in range(n_cols):
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":78
 *     for i in range(n_rows):
 *         ttl=0.
 *         for j in range(n_cols):             # <<<<<<<<<<<<<<
 *             ttl=ttl+X[i*n_cols+j]*w[j]
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "_mono_gradient_boosting.pyx":79
 *         ttl=0.
 *         for j in range(n_cols):
 *             ttl=ttl+X[i*n_cols+j]*w[j]             # <<<<<<<<<<<<<<
 *         out[i]=ttl
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":80
 *         for j in range(n_cols):
 *             ttl=ttl+X[i*n_cols+j]*w[j]
 *         out[i]=ttl             # <<<<<<<<<<<<<<
 *     return
...
/* "_mono_gradient_boosting.pyx":83
 *     return
 * 
 * def _custom_dot(np.ndarray[float64, ndim=2] X,             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_23_mono_gradient_boosting_3_custom_dot(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_custom_dot", 1, 2, 2, 1); __PYX_ERR(0, 83, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_custom_dot") < 0)) __PYX_ERR(0, 83, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_custom_dot", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 83, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_23_mono_gradient_boosting_2_custom_dot(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_w) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_23_mono_gradient_boosting_float64, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 83, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_w.rcbuffer->pybuffer, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_nn___pyx_t_23_mono_gradient_boosting_float64, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 83, __pyx_L1_error)
  }
  ...
  /* "_mono_gradient_boosting.pyx":85
 * def _custom_dot(np.ndarray[float64, ndim=2] X,
 *                 np.ndarray[float64, ndim=1] w):
 *     out=np.zeros(X.shape[0],dtype=np.float64)             # <<<<<<<<<<<<<<
 *     _custom_dot_(
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_X->dimensions[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
...
/* "_mono_gradient_boosting.pyx":95
 *     return out
 * 
 * cdef _custom_dot_multiply_(float64 *X,             # <<<<<<<<<<<<<<
 *                   float64 *w,
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":107
 *     for i in range(n_rows):
 *         ttl=0.
 *         for j in range(n_cols):             # <<<<<<<<<<<<<<
 *             ttl=ttl+X[i*n_cols+j]*w[j]
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":109
 *         for j in range(n_cols):
 *             ttl=ttl+X[i*n_cols+j]*w[j]
 *         out[i]=y[i]*(ttl+c)             # <<<<<<<<<<<<<<
 *     return
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":110
 *             ttl=ttl+X[i*n_cols+j]*w[j]
 *         out[i]=y[i]*(ttl+c)
 *     return             # <<<<<<<<<<<<<<
 * 
...
/* "_mono_gradient_boosting.pyx":112
 *     return
 * 
 * def _custom_dot_multiply(np.ndarray[float64, ndim=2] X,             # <<<<<<<<<<<<<<
 *                 np.ndarray[float64, ndim=1] w,
...
static PyObject *__pyx_pw_23_mono_gradient_boosting_5_custom_dot_multiply(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_custom_dot_multiply (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_custom_dot_multiply", 1, 4, 4, 1); __PYX_ERR(0, 112, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_custom_dot_multiply", 1, 4, 4, 2); __PYX_ERR(0, 112, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_custom_dot_multiply", 1, 4, 4, 3); __PYX_ERR(0, 112, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_custom_dot_multiply") < 0)) __PYX_ERR(0, 112, __pyx_L3_error)
      }
    ...
    __pyx_v_c = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_c == ((npy_float64)-1)) && PyErr_Occurred())) __PYX_ERR(0, 115, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_custom_dot_multiply", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 112, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_w), __pyx_ptype_5numpy_ndarray, 1, "w", 0))) __PYX_ERR(0, 113, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_y), __pyx_ptype_5numpy_ndarray, 1, "y", 0))) __PYX_ERR(0, 114, __pyx_L1_error)
...
static PyObject *__pyx_pf_23_mono_gradient_boosting_4_custom_dot_multiply(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X, PyArrayObject *__pyx_v_w, PyArrayObject *__pyx_v_y, __pyx_t_23_mono_gradient_boosting_float64 __pyx_v_c) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_23_mono_gradient_boosting_float64, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 112, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_w.rcbuffer->pybuffer, (PyObject*)__pyx_v_w, &__Pyx_TypeInfo_nn___pyx_t_23_mono_gradient_boosting_float64, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 112, __pyx_L1_error)
  }
  __pyx_pybuffernd_w.diminfo[0].strides = __pyx_pybuffernd_w.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_w.diminfo[0].shape = __pyx_pybuffernd_w.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y.rcbuffer->pybuffer, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_nn___pyx_t_23_mono_gradient_boosting_float64, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 112, __pyx_L1_error)
  }
  __pyx_pybuffernd_y.diminfo[0].strides = __pyx_pybuffernd_y.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_y.diminfo[0].shape = __pyx_pybuffernd_y.rcbuffer->pybuffer.shape[0];

  /* "_mono_gradient_boosting.pyx":116
 *                 np.ndarray[float64, ndim=1] y,
 *                 float64 c):
 *     out=np.zeros(X.shape[0],dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":117
 *                 float64 c):
 *     out=np.zeros(X.shape[0],dtype=np.float64)
 *     _custom_dot_multiply_(             # <<<<<<<<<<<<<<
 *                             <float64*> (<np.ndarray> X).data  ,
...
/* "_mono_gradient_boosting.pyx":129
 * 
 * 
...
static void __pyx_f_23_mono_gradient_boosting__apply_rules_with_map_and_feat_cache(__pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_X, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_rule_lower_corners, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_rule_upper_corners, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_samples, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_features, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_rules, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_X_leaf_node_ids, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_node_rule_map, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_out_rule_feats_upper, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_out_rule_feats_lower, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_out) {
  ...
  /* "_mono_gradient_boosting.pyx":154
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "_mono_gradient_boosting.pyx":155
 *     cdef int32 if_to_check
 *     for i in range(n_samples):
 *         leaf_id=X_leaf_node_ids[i]             # <<<<<<<<<<<<<<
 *         base_rule_id=node_rule_map[leaf_id * n_rules] # first column gives base leaf, this is the corresponding rule
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":156
 *     for i in range(n_samples):
 *         leaf_id=X_leaf_node_ids[i]
 *         base_rule_id=node_rule_map[leaf_id * n_rules] # first column gives base leaf, this is the corresponding rule             # <<<<<<<<<<<<<<
 *         out[i * n_rules + base_rule_id]=1
 ...
 */
    while (1) {
      ...
      /* "_mono_gradient_boosting.pyx":164
 *             cont=1 if node_rule_map[leaf_id * n_rules +i_r]!=-99 else 0
 *         while cont==1:
 *             r=node_rule_map[leaf_id * n_rules +i_r]             # <<<<<<<<<<<<<<
 *             res=1
 ...
 */
      ...
      /* "_mono_gradient_boosting.pyx":169
 *             if_to_check=0
 *             j=out_rule_feats_lower[leaf_id * n_rules * n_features + r*n_features + if_to_check]
 *             while j!=-99 and res!=0:             # <<<<<<<<<<<<<<
 *                 if X[j * n_samples + i] <= rule_lower_corners[j * n_rules +  r]:
 ...
 */
        ...
        /* "_mono_gradient_boosting.pyx":178
 *                 if_to_check=0
 *                 j=out_rule_feats_upper[leaf_id * n_rules * n_features + r*n_features + if_to_check]
 *                 while j!=-99 and res!=0:             # <<<<<<<<<<<<<<
 *                     if X[j * n_samples + i] > rule_upper_corners[j * n_rules +  r]:
...
/* "_mono_gradient_boosting.pyx":192
 * 
 * 
...
static void __pyx_f_23_mono_gradient_boosting__apply_rules_with_map_sparse(__pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_X, PyObject *__pyx_v_rule_lower_corners, PyObject *__pyx_v_rule_upper_corners, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_samples, CYTHON_UNUSED __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_features, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_n_rules, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_X_leaf_node_ids, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_node_rule_map, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_out) {
  ...
  /* "_mono_gradient_boosting.pyx":203
 *     """   """
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rule_lower_corners, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 203, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_lower_data = ((__pyx_t_23_mono_gradient_boosting_float64 *)((PyArrayObject *)__pyx_t_1)->data);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "_mono_gradient_boosting.pyx":204
 * 
 *     cdef float64* lower_data = <float64*>(<np.ndarray> rule_lower_corners.data).data
 *     cdef INT32_t* lower_indices = <INT32_t*>(<np.ndarray> rule_lower_corners.indices).data             # <<<<<<<<<<<<<<
 *     cdef INT32_t* lower_indptr = <INT32_t*>(<np.ndarray> rule_lower_corners.indptr).data
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rule_lower_corners, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 204, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_lower_indices = ((__pyx_t_23_mono_gradient_boosting_INT32_t *)((PyArrayObject *)__pyx_t_1)->data);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "_mono_gradient_boosting.pyx":205
 *     cdef float64* lower_data = <float64*>(<np.ndarray> rule_lower_corners.data).data
 *     cdef INT32_t* lower_indices = <INT32_t*>(<np.ndarray> rule_lower_corners.indices).data
 *     cdef INT32_t* lower_indptr = <INT32_t*>(<np.ndarray> rule_lower_corners.indptr).data             # <<<<<<<<<<<<<<
 *     cdef float64* upper_data = <float64*>(<np.ndarray> rule_upper_corners.data).data
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rule_lower_corners, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 205, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rule_upper_corners, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 206, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef int32 res
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rule_upper_corners, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 207, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_rule_upper_corners, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 208, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_upper_indptr = ((__pyx_t_23_mono_gradient_boosting_INT32_t *)((PyArrayObject *)__pyx_t_1)->data);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "_mono_gradient_boosting.pyx":221
 *     cdef int32 cont
 * 
 *     for i in range(n_samples):             # <<<<<<<<<<<<<<
 *         leaf_id=X_leaf_node_ids[i]
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "_mono_gradient_boosting.pyx":222
 * 
 *     for i in range(n_samples):
 *         leaf_id=X_leaf_node_ids[i]             # <<<<<<<<<<<<<<
 *         base_rule_id=node_rule_map[leaf_id * n_rules] # first column gives base leaf, this is the corresponding rule
 ...
 */
    ...
    /* "_mono_gradient_boosting.pyx":223
 *     for i in range(n_samples):
 *         leaf_id=X_leaf_node_ids[i]
 *         base_rule_id=node_rule_map[leaf_id * n_rules] # first column gives base leaf, this is the corresponding rule             # <<<<<<<<<<<<<<
 *         out[i * n_rules + base_rule_id]=1
 ...
 */
    while (1) {
      ...
      /* "_mono_gradient_boosting.pyx":231
 *             cont=1 if node_rule_map[leaf_id * n_rules +i_r]!=-99 else 0
 *         while cont==1:
 *             r=node_rule_map[leaf_id * n_rules +i_r]             # <<<<<<<<<<<<<<
 *             # check lower rules
 ...
 */
      ...
      /* "_mono_gradient_boosting.pyx":235
 *             rule_start=lower_indptr[r]
 *             rule_end=lower_indptr[r+1]
 *             res=1             # <<<<<<<<<<<<<<
 *             for j_test in range(rule_start,rule_end):
...
/* "_mono_gradient_boosting.pyx":254
 *                 cont=1 if node_rule_map[leaf_id * n_rules +i_r]!=-99 else 0
 * 
 * cdef int32 _search_sorted(float64 *arr, int32 arr_start_idx,int32 arr_len,int32 stride, float64 val):             # <<<<<<<<<<<<<<
 *     cdef int32 first
...
static __pyx_t_23_mono_gradient_boosting_int32 __pyx_f_23_mono_gradient_boosting__search_sorted(__pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_arr, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_arr_start_idx, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_arr_len, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_stride, __pyx_t_23_mono_gradient_boosting_float64 __pyx_v_val) {
  ...
  /* "_mono_gradient_boosting.pyx":259
 *     cdef int32 found
 *     cdef int32 midpoint
 *     first = 0             # <<<<<<<<<<<<<<
 *     last=arr_len-1
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":260
 *     cdef int32 midpoint
 *     first = 0
 *     last=arr_len-1             # <<<<<<<<<<<<<<
 *     found = 0
 ...
 */
  ...
  /* "_mono_gradient_boosting.pyx":261
 *     first = 0
 *     last=arr_len-1
 *     found = 0             # <<<<<<<<<<<<<<
 *     # right sided by default
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "_mono_gradient_boosting.pyx":266
 *         midpoint = (first + last)//2
 *         if midpoint<(arr_len-1) :
 *             if arr[arr_start_idx+midpoint*stride] <= val and arr[arr_start_idx+(midpoint+1)*stride] > val:             # <<<<<<<<<<<<<<
 *                 found=1
...
static PyObject *__pyx_f_23_mono_gradient_boosting__traverse_node_c(__pyx_t_23_mono_gradient_boosting_int32 __pyx_v_node_id, __pyx_t_23_mono_gradient_boosting_int32 __pyx_v_num_feats, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_children_left, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_children_right, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_features, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_thresholds, __pyx_t_23_mono_gradient_boosting_int32 *__pyx_v_out_leaf_ids, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_out_rule_upper_corners, __pyx_t_23_mono_gradient_boosting_float64 *__pyx_v_out_rule_lower_corners) {
  ...
  /* "_mono_gradient_boosting.pyx":311
 *     cdef int32 j
 *     # recurse on children
 ...
 */
    __pyx_t_5 = __pyx_f_23_mono_gradient_boosting__traverse_node_c(__pyx_v_left_node_id, __pyx_v_num_feats, __pyx_v_children_left, __pyx_v_children_right, __pyx_v_features, __pyx_v_thresholds, __pyx_v_out_leaf_ids, __pyx_v_out_rule_upper_corners, __pyx_v_out_rule_lower_corners); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 325, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *     else:  # a leaf node
 */
    __pyx_t_5 = __pyx_f_23_mono_gradient_boosting__traverse_node_c(__pyx_v_right_node_id, __pyx_v_num_feats, __pyx_v_children_left, __pyx_v_children_right, __pyx_v_features, __pyx_v_thresholds, __pyx_v_out_leaf_ids, __pyx_v_out_rule_upper_corners, __pyx_v_out_rule_lower_corners); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 327, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  ...
  if (!__pyx_t_3) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_v_rule_lower_corners); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1096, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_2)) {
 ...
 *     out=np.empty_like(X)
 */
  __pyx_tuple__13 = PyTuple_Pack(3, __pyx_n_s_n_samples, __pyx_n_s_X, __pyx_n_s_out); if (unlikely(!__pyx_tuple__13)) __PYX_ERR(0, 59, __pyx_L1_error)
 ...
 *     out=np.zeros(X.shape[0],dtype=np.float64)
 */
  __pyx_tuple__15 = PyTuple_Pack(3, __pyx_n_s_X, __pyx_n_s_w, __pyx_n_s_out); if (unlikely(!__pyx_tuple__15)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__15);
  __Pyx_GIVEREF(__pyx_tuple__15);
  __pyx_codeobj__16 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__15, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mono_gradient_boosting_pyx, __pyx_n_s_custom_dot, 83, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__16)) __PYX_ERR(0, 83, __pyx_L1_error)
 ...
 *                 np.ndarray[float64, ndim=1] y,
 */
  __pyx_tuple__17 = PyTuple_Pack(5, __pyx_n_s_X, __pyx_n_s_w, __pyx_n_s_y, __pyx_n_s_c, __pyx_n_s_out); if (unlikely(!__pyx_tuple__17)) __PYX_ERR(0, 112, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "_mono_gradient_boosting.pyx":16
 ...
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_scipy_sparse, __pyx_t_1, -1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_issparse); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_issparse, __pyx_t_1) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "_mono_gradient_boosting.pyx":21
 * 
 * from scipy.sparse import issparse
 * from scipy.sparse import csr_matrix             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_scipy_sparse, __pyx_t_3, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_csr_matrix); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_csr_matrix, __pyx_t_3) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_numpy, __pyx_t_1, -1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np_zeros, __pyx_t_1) < 0) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "_mono_gradient_boosting.pyx":36
 * # no namespace lookup for numpy dtype and array creation
 * from numpy import zeros as np_zeros
 * from numpy import ones as np_ones             # <<<<<<<<<<<<<<
 * from numpy import bool as np_bool
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, __pyx_t_3, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_ones); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np_ones, __pyx_t_3) < 0) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_numpy, __pyx_t_1, -1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_bool); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np_bool, __pyx_t_1) < 0) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_numpy, __pyx_t_3, -1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_float32); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np_float32, __pyx_t_3) < 0) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_Import(__pyx_n_s_numpy, __pyx_t_1, -1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_3, __pyx_n_s_float64); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_np_float64, __pyx_t_1) < 0) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *     out=np.empty_like(X)
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_23_mono_gradient_boosting_1_log_logistic_sigmoid, NULL, __pyx_n_s_mono_gradient_boosting); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_log_logistic_sigmoid, __pyx_t_3) < 0) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *     out=np.zeros(X.shape[0],dtype=np.float64)
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_23_mono_gradient_boosting_3_custom_dot, NULL, __pyx_n_s_mono_gradient_boosting); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_custom_dot, __pyx_t_3) < 0) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *                 np.ndarray[float64, ndim=1] y,
 */
  __pyx_t_3 = PyCFunction_NewEx(&__pyx_mdef_23_mono_gradient_boosting_5_custom_dot_multiply, NULL, __pyx_n_s_mono_gradient_boosting); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 112, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
