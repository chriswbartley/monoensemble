...
# -*- coding: utf-8 -*-
#
# monoensemble documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../monoensemble/'))
...
htmlhelp_basename = 'monoensembledoc'
...
latex_documents = [
  ('index', 'monoensemble.tex', 'monoensemble Documentation',
...
man_pages = [
    ('index', 'monoensemble', 'monoensemble Documentation',
...
texinfo_documents = [
  ('index', 'monoensemble', 'monoensemble Documentation',
   'Christopher Bartley', 'monoensemble', 'One line description of project.',
   'Miscellaneous'),
]
